...
# V = np.zeros((len(terminal2node), simLength))
# I1 = np.zeros((len(terminal2node), simLength))
# I2 = np.zeros((len(terminal2node), simLength))
...
sio.savemat("Q.mat", {"Q": Q}) 
sio.savemat("V.mat", {"V": V})
sio.savemat("I.mat", {"I": I}) 
sio.savemat("Y.mat", {"Y": Y})

# Start the MATLAB engine 
# eng = matlab.engine.start_server(background=False, servername='/Applications/MATLAB_R2022b.app')
eng = matlab.engine.start_matlab()

# script_path = '/Users/saki/cosimul/co_sim_platform/SmartGridMain/OpenDSS-wrapper-main/examples/For_python/state_est_py.m'
Vmagph = eng.state_est_py(P,Q,V,I,Y, nargout=2)
# Define MATLAB function name and input arguments (replace accordingly)
# eng.stop()
print("MATLAB script execution complete (using eval)")
# print(Vmagph)
